...
```mermaid
flowchart TB
    R[Router / switch exporters] -->|Source-restricted UDP| H[Ubuntu collector host]
    subgraph H[Ubuntu collector host]
    ...
    H -. Optional HTTPS .-> D[Discord / webhook receiver]
    H -. Optional broker connection .-> K[Kafka cluster]
    M[Local monitoring agent] -->|127.0.0.1:8080| H
```
